...
class MainWindow(object):
    ...
    def setupOrderUi(self):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 377, 372))
        self.scrollAreaWidgetContents.setObjectName("scrollAreaWidgetContents")
        self.verticalLayoutWidget_2 = QtWidgets.QWidget(self.scrollAreaWidgetContents)
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(-1, -1, 381, 371))
        self.verticalLayoutWidget_2.setObjectName("verticalLayoutWidget_2")
        self.categorieslayout = QtWidgets.QVBoxLayout(self.verticalLayoutWidget_2)
        self.categorieslayout.setSizeConstraint(QtWidgets.QLayout.SetMaximumSize)
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 376, 372))
        self.scrollAreaWidgetContents_2.setObjectName("scrollAreaWidgetContents_2")
        self.gridLayoutWidget = QtWidgets.QWidget(self.scrollAreaWidgetContents_2)
        self.gridLayoutWidget.setGeometry(QtCore.QRect(-1, -1, 381, 371))
